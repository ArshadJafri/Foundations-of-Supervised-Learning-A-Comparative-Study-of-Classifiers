...
np.save('weights_non_reg3.npy', model_non_reg.weights)
np.save('bias_non_reg3.npy', model_non_reg.bias)
np.save('weights_reg3.npy', model_reg.weights)
np.save('bias_reg3.npy', model_reg.bias)
