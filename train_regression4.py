...
np.save('weights_non_reg4.npy', model_non_reg.weights)
np.save('bias_non_reg4.npy', model_non_reg.bias)
np.save('weights_reg4.npy', model_reg.weights)
np.save('bias_reg4.npy', model_reg.bias)
